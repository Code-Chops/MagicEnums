...
{
    /// <summary>
    /// Multiple threads should create enum options with explicit incremental values using CreateMember.
    ...
    /// <summary>
    /// Multiple threads should create enum options with explicit incremental values using GetOrCreateMember.
    /// The order is not guaranteed.
    /// </summary>
    [Fact]
